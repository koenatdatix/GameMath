...
std::array<float, 4> gm::CreateQuaternion(float angle, float x, float y, float z)
{
	std::array<float, 4> result;
	float a2{ angle / 2.f };
	float
...
std::array<float, 4> gm::QuaternionMultiply(const std::array<float, 4>& quat1, const std::array<float, 4>& quat2)
{
